...
.. csv-table::
   ...
   0x05c, :ref:`SM0_CLK_ENABLE <SM0_CLK_ENABLE-details-label>`, "Read-only access to the SM's current clock enable status."
   0x060, :ref:`SM0_NEXT_CLK_ENABLE <SM0_NEXT_CLK_ENABLE-details-label>`, "Read-only access to the SM's next clock enable status.  May differ from current clock enable when master clock phase 1 has been completed, otherwise identical with current clock enable."
   0x064, :ref:`SM0_BREAKPOINTS <SM0_BREAKPOINTS-details-label>`, "Each bit of this value corresponds to each of the 32 memory locations of the PIO instruction memory (with the LSB of the word corresponding to the lowest memory address).  Setting a bit to 1 marks the corresponding memory address as location of a breakpoint.  Setting a bit to 0 removes the breakpoint.  As soon as the program counter of the state machine reaches an address that is marked as a breakpoint, master clock MASTERCLK_MODE will be automatically set to single step mode."
   0x068, :ref:`SM0_TRACEPOINTS <SM0_TRACEPOINTS-details-label>`, "Tracepoints work like breakpoints with the difference that master clock MASTERCLK_MODE it not automatically set to single step mode, but instead a message is typically printed to console output (depending on the specific client application).  The message may, for example, caontain the state machine's number and disassembled instruction with prefixed instruction memory address.  Tracepoints work in all master clock MASTERCLK_MODE modes."
   0x06c, :ref:`SM1_REGX <SM1_REGX-details-label>`, "Direct read / write access to the SM's scratch register X."
   0x070, :ref:`SM1_REGY <SM1_REGY-details-label>`, "Direct read / write access to the SM's scratch register Y."
   0x074, :ref:`SM1_PC <SM1_PC-details-label>`, "Direct read / write access to the SM's instruction pointer / program counter."
   0x078, :ref:`SM1_ISR <SM1_ISR-details-label>`, "Direct read / write access to the SM's input shift register."
   0x07c, :ref:`SM1_ISR_SHIFT_COUNT <SM1_ISR_SHIFT_COUNT-details-label>`, "Direct read / write access to the SM's input shift count register."
   0x080, :ref:`SM1_OSR <SM1_OSR-details-label>`, "Direct read / write access to all of the SM's output shift register."
   0x084, :ref:`SM1_OSR_SHIFT_COUNT <SM1_OSR_SHIFT_COUNT-details-label>`, "Direct read / write access to the SM's output shift count register."
   0x088, :ref:`SM1_FIFO_MEM0 <SM1_FIFO_MEM0-details-label>`, "Read / write access to FIFO memory word."
   0x08c, :ref:`SM1_FIFO_MEM1 <SM1_FIFO_MEM1-details-label>`, "Read / write access to FIFO memory word."
   0x090, :ref:`SM1_FIFO_MEM2 <SM1_FIFO_MEM2-details-label>`, "Read / write access to FIFO memory word."
   0x094, :ref:`SM1_FIFO_MEM3 <SM1_FIFO_MEM3-details-label>`, "Read / write access to FIFO memory word."
   0x098, :ref:`SM1_FIFO_MEM4 <SM1_FIFO_MEM4-details-label>`, "Read / write access to FIFO memory word."
   0x09c, :ref:`SM1_FIFO_MEM5 <SM1_FIFO_MEM5-details-label>`, "Read / write access to FIFO memory word."
   0x0a0, :ref:`SM1_FIFO_MEM6 <SM1_FIFO_MEM6-details-label>`, "Read / write access to FIFO memory word."
   0x0a4, :ref:`SM1_FIFO_MEM7 <SM1_FIFO_MEM7-details-label>`, "Read / write access to FIFO memory word."
   0x0a8, :ref:`SM1_CLEAR_FORCED <SM1_CLEAR_FORCED-details-label>`, "When writing to this address, any pending forced instruction is cancelled, provided that instruction fetch & decode has not yet been started."
   0x0ac, :ref:`SM1_CLEAR_EXECD <SM1_CLEAR_EXECD-details-label>`, "When writing to this address, any pending EXEC'd instruction is cancelled, provided that instruction fetch & decode has not yet been started."
   0x0b0, :ref:`SM1_INSTR_ORIGIN <SM1_INSTR_ORIGIN-details-label>`, "Direct read-only access to the origin of the SM's currently executed instruction.  The mode bits determine the origin category.  If the origin category is memory address, the memory address bits will contain the memory instruction's address. Otherwise, the bits of the memory address are undefined. Note that for memory instructions, the address may differ from the value of the instruction pointer PC, if the PC has already been updated while the instruction is still in progress."
   0x0b4, :ref:`SM1_DELAY <SM1_DELAY-details-label>`, "Direct read-only access to the SM's currently executed instruction's number of delay cycles."
   0x0b8, :ref:`SM1_DELAY_CYCLE <SM1_DELAY_CYCLE-details-label>`, "Read-only access to the SM's delay status."
   0x0bc, :ref:`SM1_PENDING_DELAY <SM1_PENDING_DELAY-details-label>`, "Direct read-only access to the SM's number of pending delay cycles."
   0x0c0, :ref:`SM1_FORCED_INSTR <SM1_FORCED_INSTR-details-label>`, "Direct read-only access to the op-code of a forced instruction that is awaiting execution during the next clock cycle.  For writing a forced instruction, use SMx_INSTR of PIORegisters instead."
   0x0c4, :ref:`SM1_EXECD_INSTR <SM1_EXECD_INSTR-details-label>`, "Direct read/write access to the op-code of an EXEC'd instruction that is awaiting execution during the next clock cycle, unless the state machine's clock signal does not evaluate to true, or there is a pending forced instruction, in which case the forced instruction will be executed first."
   0x0c8, :ref:`SM1_CLK_ENABLE <SM1_CLK_ENABLE-details-label>`, "Read-only access to the SM's current clock enable status."
   0x0cc, :ref:`SM1_NEXT_CLK_ENABLE <SM1_NEXT_CLK_ENABLE-details-label>`, "Read-only access to the SM's next clock enable status.  May differ from current clock enable when master clock phase 1 has been completed, otherwise identical with current clock enable."
   0x0d0, :ref:`SM1_BREAKPOINTS <SM1_BREAKPOINTS-details-label>`, "Each bit of this value corresponds to each of the 32 memory locations of the PIO instruction memory (with the LSB of the word corresponding to the lowest memory address).  Setting a bit to 1 marks the corresponding memory address as location of a breakpoint.  Setting a bit to 0 removes the breakpoint.  As soon as the program counter of the state machine reaches an address that is marked as a breakpoint, master clock MASTERCLK_MODE will be automatically set to single step mode."
   0x0d4, :ref:`SM1_TRACEPOINTS <SM1_TRACEPOINTS-details-label>`, "Tracepoints work like breakpoints with the difference that master clock MASTERCLK_MODE it not automatically set to single step mode, but instead a message is typically printed to console output (depending on the specific client application).  The message may, for example, caontain the state machine's number and disassembled instruction with prefixed instruction memory address.  Tracepoints work in all master clock MASTERCLK_MODE modes."
   0x0d8, :ref:`SM2_REGX <SM2_REGX-details-label>`, "Direct read / write access to the SM's scratch register X."
   0x0dc, :ref:`SM2_REGY <SM2_REGY-details-label>`, "Direct read / write access to the SM's scratch register Y."
   0x0e0, :ref:`SM2_PC <SM2_PC-details-label>`, "Direct read / write access to the SM's instruction pointer / program counter."
   0x0e4, :ref:`SM2_ISR <SM2_ISR-details-label>`, "Direct read / write access to the SM's input shift register."
   0x0e8, :ref:`SM2_ISR_SHIFT_COUNT <SM2_ISR_SHIFT_COUNT-details-label>`, "Direct read / write access to the SM's input shift count register."
   0x0ec, :ref:`SM2_OSR <SM2_OSR-details-label>`, "Direct read / write access to all of the SM's output shift register."
   0x0f0, :ref:`SM2_OSR_SHIFT_COUNT <SM2_OSR_SHIFT_COUNT-details-label>`, "Direct read / write access to the SM's output shift count register."
   0x0f4, :ref:`SM2_FIFO_MEM0 <SM2_FIFO_MEM0-details-label>`, "Read / write access to FIFO memory word."
   0x0f8, :ref:`SM2_FIFO_MEM1 <SM2_FIFO_MEM1-details-label>`, "Read / write access to FIFO memory word."
   0x0fc, :ref:`SM2_FIFO_MEM2 <SM2_FIFO_MEM2-details-label>`, "Read / write access to FIFO memory word."
   0x100, :ref:`SM2_FIFO_MEM3 <SM2_FIFO_MEM3-details-label>`, "Read / write access to FIFO memory word."
   0x104, :ref:`SM2_FIFO_MEM4 <SM2_FIFO_MEM4-details-label>`, "Read / write access to FIFO memory word."
   0x108, :ref:`SM2_FIFO_MEM5 <SM2_FIFO_MEM5-details-label>`, "Read / write access to FIFO memory word."
   0x10c, :ref:`SM2_FIFO_MEM6 <SM2_FIFO_MEM6-details-label>`, "Read / write access to FIFO memory word."
   0x110, :ref:`SM2_FIFO_MEM7 <SM2_FIFO_MEM7-details-label>`, "Read / write access to FIFO memory word."
   0x114, :ref:`SM2_CLEAR_FORCED <SM2_CLEAR_FORCED-details-label>`, "When writing to this address, any pending forced instruction is cancelled, provided that instruction fetch & decode has not yet been started."
   0x118, :ref:`SM2_CLEAR_EXECD <SM2_CLEAR_EXECD-details-label>`, "When writing to this address, any pending EXEC'd instruction is cancelled, provided that instruction fetch & decode has not yet been started."
   0x11c, :ref:`SM2_INSTR_ORIGIN <SM2_INSTR_ORIGIN-details-label>`, "Direct read-only access to the origin of the SM's currently executed instruction.  The mode bits determine the origin category.  If the origin category is memory address, the memory address bits will contain the memory instruction's address. Otherwise, the bits of the memory address are undefined. Note that for memory instructions, the address may differ from the value of the instruction pointer PC, if the PC has already been updated while the instruction is still in progress."
   0x120, :ref:`SM2_DELAY <SM2_DELAY-details-label>`, "Direct read-only access to the SM's currently executed instruction's number of delay cycles."
   0x124, :ref:`SM2_DELAY_CYCLE <SM2_DELAY_CYCLE-details-label>`, "Read-only access to the SM's delay status."
   0x128, :ref:`SM2_PENDING_DELAY <SM2_PENDING_DELAY-details-label>`, "Direct read-only access to the SM's number of pending delay cycles."
   0x12c, :ref:`SM2_FORCED_INSTR <SM2_FORCED_INSTR-details-label>`, "Direct read-only access to the op-code of a forced instruction that is awaiting execution during the next clock cycle.  For writing a forced instruction, use SMx_INSTR of PIORegisters instead."
   0x130, :ref:`SM2_EXECD_INSTR <SM2_EXECD_INSTR-details-label>`, "Direct read/write access to the op-code of an EXEC'd instruction that is awaiting execution during the next clock cycle, unless the state machine's clock signal does not evaluate to true, or there is a pending forced instruction, in which case the forced instruction will be executed first."
   0x134, :ref:`SM2_CLK_ENABLE <SM2_CLK_ENABLE-details-label>`, "Read-only access to the SM's current clock enable status."
   0x138, :ref:`SM2_NEXT_CLK_ENABLE <SM2_NEXT_CLK_ENABLE-details-label>`, "Read-only access to the SM's next clock enable status.  May differ from current clock enable when master clock phase 1 has been completed, otherwise identical with current clock enable."
   0x13c, :ref:`SM2_BREAKPOINTS <SM2_BREAKPOINTS-details-label>`, "Each bit of this value corresponds to each of the 32 memory locations of the PIO instruction memory (with the LSB of the word corresponding to the lowest memory address).  Setting a bit to 1 marks the corresponding memory address as location of a breakpoint.  Setting a bit to 0 removes the breakpoint.  As soon as the program counter of the state machine reaches an address that is marked as a breakpoint, master clock MASTERCLK_MODE will be automatically set to single step mode."
   0x140, :ref:`SM2_TRACEPOINTS <SM2_TRACEPOINTS-details-label>`, "Tracepoints work like breakpoints with the difference that master clock MASTERCLK_MODE it not automatically set to single step mode, but instead a message is typically printed to console output (depending on the specific client application).  The message may, for example, caontain the state machine's number and disassembled instruction with prefixed instruction memory address.  Tracepoints work in all master clock MASTERCLK_MODE modes."
   0x144, :ref:`SM3_REGX <SM3_REGX-details-label>`, "Direct read / write access to the SM's scratch register X."
   0x148, :ref:`SM3_REGY <SM3_REGY-details-label>`, "Direct read / write access to the SM's scratch register Y."
   0x14c, :ref:`SM3_PC <SM3_PC-details-label>`, "Direct read / write access to the SM's instruction pointer / program counter."
   0x150, :ref:`SM3_ISR <SM3_ISR-details-label>`, "Direct read / write access to the SM's input shift register."
   0x154, :ref:`SM3_ISR_SHIFT_COUNT <SM3_ISR_SHIFT_COUNT-details-label>`, "Direct read / write access to the SM's input shift count register."
   0x158, :ref:`SM3_OSR <SM3_OSR-details-label>`, "Direct read / write access to all of the SM's output shift register."
   0x15c, :ref:`SM3_OSR_SHIFT_COUNT <SM3_OSR_SHIFT_COUNT-details-label>`, "Direct read / write access to the SM's output shift count register."
   0x160, :ref:`SM3_FIFO_MEM0 <SM3_FIFO_MEM0-details-label>`, "Read / write access to FIFO memory word."
   0x164, :ref:`SM3_FIFO_MEM1 <SM3_FIFO_MEM1-details-label>`, "Read / write access to FIFO memory word."
   0x168, :ref:`SM3_FIFO_MEM2 <SM3_FIFO_MEM2-details-label>`, "Read / write access to FIFO memory word."
   0x16c, :ref:`SM3_FIFO_MEM3 <SM3_FIFO_MEM3-details-label>`, "Read / write access to FIFO memory word."
   0x170, :ref:`SM3_FIFO_MEM4 <SM3_FIFO_MEM4-details-label>`, "Read / write access to FIFO memory word."
   0x174, :ref:`SM3_FIFO_MEM5 <SM3_FIFO_MEM5-details-label>`, "Read / write access to FIFO memory word."
   0x178, :ref:`SM3_FIFO_MEM6 <SM3_FIFO_MEM6-details-label>`, "Read / write access to FIFO memory word."
   0x17c, :ref:`SM3_FIFO_MEM7 <SM3_FIFO_MEM7-details-label>`, "Read / write access to FIFO memory word."
   0x180, :ref:`SM3_CLEAR_FORCED <SM3_CLEAR_FORCED-details-label>`, "When writing to this address, any pending forced instruction is cancelled, provided that instruction fetch & decode has not yet been started."
   0x184, :ref:`SM3_CLEAR_EXECD <SM3_CLEAR_EXECD-details-label>`, "When writing to this address, any pending EXEC'd instruction is cancelled, provided that instruction fetch & decode has not yet been started."
   0x188, :ref:`SM3_INSTR_ORIGIN <SM3_INSTR_ORIGIN-details-label>`, "Direct read-only access to the origin of the SM's currently executed instruction.  The mode bits determine the origin category.  If the origin category is memory address, the memory address bits will contain the memory instruction's address. Otherwise, the bits of the memory address are undefined. Note that for memory instructions, the address may differ from the value of the instruction pointer PC, if the PC has already been updated while the instruction is still in progress."
   0x18c, :ref:`SM3_DELAY <SM3_DELAY-details-label>`, "Direct read-only access to the SM's currently executed instruction's number of delay cycles."
   0x190, :ref:`SM3_DELAY_CYCLE <SM3_DELAY_CYCLE-details-label>`, "Read-only access to the SM's delay status."
   0x194, :ref:`SM3_PENDING_DELAY <SM3_PENDING_DELAY-details-label>`, "Direct read-only access to the SM's number of pending delay cycles."
   0x198, :ref:`SM3_FORCED_INSTR <SM3_FORCED_INSTR-details-label>`, "Direct read-only access to the op-code of a forced instruction that is awaiting execution during the next clock cycle.  For writing a forced instruction, use SMx_INSTR of PIORegisters instead."
   0x19c, :ref:`SM3_EXECD_INSTR <SM3_EXECD_INSTR-details-label>`, "Direct read/write access to the op-code of an EXEC'd instruction that is awaiting execution during the next clock cycle, unless the state machine's clock signal does not evaluate to true, or there is a pending forced instruction, in which case the forced instruction will be executed first."
   0x1a0, :ref:`SM3_CLK_ENABLE <SM3_CLK_ENABLE-details-label>`, "Read-only access to the SM's current clock enable status."
   0x1a4, :ref:`SM3_NEXT_CLK_ENABLE <SM3_NEXT_CLK_ENABLE-details-label>`, "Read-only access to the SM's next clock enable status.  May differ from current clock enable when master clock phase 1 has been completed, otherwise identical with current clock enable."
   0x1a8, :ref:`SM3_BREAKPOINTS <SM3_BREAKPOINTS-details-label>`, "Each bit of this value corresponds to each of the 32 memory locations of the PIO instruction memory (with the LSB of the word corresponding to the lowest memory address).  Setting a bit to 1 marks the corresponding memory address as location of a breakpoint.  Setting a bit to 0 removes the breakpoint.  As soon as the program counter of the state machine reaches an address that is marked as a breakpoint, master clock MASTERCLK_MODE will be automatically set to single step mode."
   0x1ac, :ref:`SM3_TRACEPOINTS <SM3_TRACEPOINTS-details-label>`, "Tracepoints work like breakpoints with the difference that master clock MASTERCLK_MODE it not automatically set to single step mode, but instead a message is typically printed to console output (depending on the specific client application).  The message may, for example, caontain the state machine's number and disassembled instruction with prefixed instruction memory address.  Tracepoints work in all master clock MASTERCLK_MODE modes."
   0x1b0, :ref:`INSTR_MEM0 <INSTR_MEM0-details-label>`, "Read / write access to instruction memory word."
   0x1b4, :ref:`INSTR_MEM1 <INSTR_MEM1-details-label>`, "Read / write access to instruction memory word."
   0x1b8, :ref:`INSTR_MEM2 <INSTR_MEM2-details-label>`, "Read / write access to instruction memory word."
   0x1bc, :ref:`INSTR_MEM3 <INSTR_MEM3-details-label>`, "Read / write access to instruction memory word."
   0x1c0, :ref:`INSTR_MEM4 <INSTR_MEM4-details-label>`, "Read / write access to instruction memory word."
   0x1c4, :ref:`INSTR_MEM5 <INSTR_MEM5-details-label>`, "Read / write access to instruction memory word."
   0x1c8, :ref:`INSTR_MEM6 <INSTR_MEM6-details-label>`, "Read / write access to instruction memory word."
   0x1cc, :ref:`INSTR_MEM7 <INSTR_MEM7-details-label>`, "Read / write access to instruction memory word."
   0x1d0, :ref:`INSTR_MEM8 <INSTR_MEM8-details-label>`, "Read / write access to instruction memory word."
   0x1d4, :ref:`INSTR_MEM9 <INSTR_MEM9-details-label>`, "Read / write access to instruction memory word."
   0x1d8, :ref:`INSTR_MEM10 <INSTR_MEM10-details-label>`, "Read / write access to instruction memory word."
   0x1dc, :ref:`INSTR_MEM11 <INSTR_MEM11-details-label>`, "Read / write access to instruction memory word."
   0x1e0, :ref:`INSTR_MEM12 <INSTR_MEM12-details-label>`, "Read / write access to instruction memory word."
   0x1e4, :ref:`INSTR_MEM13 <INSTR_MEM13-details-label>`, "Read / write access to instruction memory word."
   0x1e8, :ref:`INSTR_MEM14 <INSTR_MEM14-details-label>`, "Read / write access to instruction memory word."
   0x1ec, :ref:`INSTR_MEM15 <INSTR_MEM15-details-label>`, "Read / write access to instruction memory word."
   0x1f0, :ref:`INSTR_MEM16 <INSTR_MEM16-details-label>`, "Read / write access to instruction memory word."
   0x1f4, :ref:`INSTR_MEM17 <INSTR_MEM17-details-label>`, "Read / write access to instruction memory word."
   0x1f8, :ref:`INSTR_MEM18 <INSTR_MEM18-details-label>`, "Read / write access to instruction memory word."
   0x1fc, :ref:`INSTR_MEM19 <INSTR_MEM19-details-label>`, "Read / write access to instruction memory word."
   0x200, :ref:`INSTR_MEM20 <INSTR_MEM20-details-label>`, "Read / write access to instruction memory word."
   0x204, :ref:`INSTR_MEM21 <INSTR_MEM21-details-label>`, "Read / write access to instruction memory word."
   0x208, :ref:`INSTR_MEM22 <INSTR_MEM22-details-label>`, "Read / write access to instruction memory word."
   0x20c, :ref:`INSTR_MEM23 <INSTR_MEM23-details-label>`, "Read / write access to instruction memory word."
   0x210, :ref:`INSTR_MEM24 <INSTR_MEM24-details-label>`, "Read / write access to instruction memory word."
   0x214, :ref:`INSTR_MEM25 <INSTR_MEM25-details-label>`, "Read / write access to instruction memory word."
   0x218, :ref:`INSTR_MEM26 <INSTR_MEM26-details-label>`, "Read / write access to instruction memory word."
   0x21c, :ref:`INSTR_MEM27 <INSTR_MEM27-details-label>`, "Read / write access to instruction memory word."
   0x220, :ref:`INSTR_MEM28 <INSTR_MEM28-details-label>`, "Read / write access to instruction memory word."
   0x224, :ref:`INSTR_MEM29 <INSTR_MEM29-details-label>`, "Read / write access to instruction memory word."
   0x228, :ref:`INSTR_MEM30 <INSTR_MEM30-details-label>`, "Read / write access to instruction memory word."
   0x22c, :ref:`INSTR_MEM31 <INSTR_MEM31-details-label>`, "Read / write access to instruction memory word."
   0x230, :ref:`TXF0 <TXF0-details-label>`, "Direct read access to the TX FIFO for the corresponding state machine.  Each read pops one word from the FIFO. Attempting to read from an empty FIFO has no effect on the FIFO state, and sets the sticky FDEBUG_TXUNDER error flag for this FIFO. The data returned to the system on a read from an empty FIFO is undefined."
   0x234, :ref:`TXF1 <TXF1-details-label>`, "Direct read access to the TX FIFO for the corresponding state machine.  Each read pops one word from the FIFO. Attempting to read from an empty FIFO has no effect on the FIFO state, and sets the sticky FDEBUG_TXUNDER error flag for this FIFO. The data returned to the system on a read from an empty FIFO is undefined."
   0x238, :ref:`TXF2 <TXF2-details-label>`, "Direct read access to the TX FIFO for the corresponding state machine.  Each read pops one word from the FIFO. Attempting to read from an empty FIFO has no effect on the FIFO state, and sets the sticky FDEBUG_TXUNDER error flag for this FIFO. The data returned to the system on a read from an empty FIFO is undefined."
   0x23c, :ref:`TXF3 <TXF3-details-label>`, "Direct read access to the TX FIFO for the corresponding state machine.  Each read pops one word from the FIFO. Attempting to read from an empty FIFO has no effect on the FIFO state, and sets the sticky FDEBUG_TXUNDER error flag for this FIFO. The data returned to the system on a read from an empty FIFO is undefined."
   0x240, :ref:`RXF0 <RXF0-details-label>`, "Direct write access to the RX FIFO for the corresponding state machine.  Each write pushes one word to the FIFO.  Attempting to write to a full FIFO has no effect on the FIFO state or contents, and sets the sticky FDEBUG_RXOVER error flag for this FIFO."
   0x244, :ref:`RXF1 <RXF1-details-label>`, "Direct write access to the RX FIFO for the corresponding state machine.  Each write pushes one word to the FIFO.  Attempting to write to a full FIFO has no effect on the FIFO state or contents, and sets the sticky FDEBUG_RXOVER error flag for this FIFO."
   0x248, :ref:`RXF2 <RXF2-details-label>`, "Direct write access to the RX FIFO for the corresponding state machine.  Each write pushes one word to the FIFO.  Attempting to write to a full FIFO has no effect on the FIFO state or contents, and sets the sticky FDEBUG_RXOVER error flag for this FIFO."
   0x24c, :ref:`RXF3 <RXF3-details-label>`, "Direct write access to the RX FIFO for the corresponding state machine.  Each write pushes one word to the FIFO.  Attempting to write to a full FIFO has no effect on the FIFO state or contents, and sets the sticky FDEBUG_RXOVER error flag for this FIFO."
   0x250, :ref:`FREAD_PTR <FREAD_PTR-details-label>`, "Read pointers of all of the SM's TX and RX FIFOs."
   0x254, :ref:`GPIO_PINS <GPIO_PINS-details-label>`, "Direct read / write access to all of the 32 GPIO pins that PIO is currently driving to the GPIOs."
   0x258, :ref:`GPIO_PINDIRS <GPIO_PINDIRS-details-label>`, "Direct read / write access to all of the 32 GPIO pin directions that PIO is currently driving to the GPIOs."
   0x25c, :ref:`IRQ <IRQ-details-label>`, "Direct read access of all PIO IRQ."
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_REGX Register
-------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_REGY Register
-------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_PC Register
-----------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_ISR Register
------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_ISR_SHIFT_COUNT Register
------------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_OSR Register
------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_OSR_SHIFT_COUNT Register
------------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_FIFO_MEM0 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_FIFO_MEM1 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_FIFO_MEM2 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_FIFO_MEM3 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_FIFO_MEM4 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_FIFO_MEM5 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_FIFO_MEM6 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_FIFO_MEM7 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_CLEAR_FORCED Register
---------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_CLEAR_EXECD Register
--------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_INSTR_ORIGIN Register
---------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_DELAY Register
--------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_DELAY_CYCLE Register
--------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_PENDING_DELAY Register
----------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_FORCED_INSTR Register
---------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_EXECD_INSTR Register
--------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_CLK_ENABLE Register
-------------------------------------------------------------------------------------------
...
Read-only access to the SM's current clock enable status.
...
.. csv-table::
   ...
   31:1, Unused., "―", ―, ―
   0, CLK_ENABLE, "0x1, if in the current cycle the clock enable signal evaluates to 0x1.", RO, 0

.. _SM0_NEXT_CLK_ENABLE-details-label:

.. index::
   single: register details; SM0_NEXT_CLK_ENABLE
   single: SM0_NEXT_CLK_ENABLE

:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_NEXT_CLK_ENABLE Register
------------------------------------------------------------------------------------------------
...
Read-only access to the SM's next clock enable
status.  May differ from current clock enable
when master clock phase 1 has been completed,
...
.. csv-table::
   ...
   31:1, Unused., "―", ―, ―
   0, CLK_ENABLE, "0x1, if in the pre-computed clock enable signal for the upcoming master clock cycle evaluates to 0x1.", RO, 0
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_BREAKPOINTS Register
--------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM0_TRACEPOINTS Register
--------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_REGX Register
-------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_REGY Register
-------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_PC Register
-----------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_ISR Register
------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_ISR_SHIFT_COUNT Register
------------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_OSR Register
------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_OSR_SHIFT_COUNT Register
------------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_FIFO_MEM0 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_FIFO_MEM1 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_FIFO_MEM2 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_FIFO_MEM3 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_FIFO_MEM4 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_FIFO_MEM5 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_FIFO_MEM6 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_FIFO_MEM7 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_CLEAR_FORCED Register
---------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_CLEAR_EXECD Register
--------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_INSTR_ORIGIN Register
---------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_DELAY Register
--------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_DELAY_CYCLE Register
--------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_PENDING_DELAY Register
----------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_FORCED_INSTR Register
---------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_EXECD_INSTR Register
--------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_CLK_ENABLE Register
-------------------------------------------------------------------------------------------
...
.. _SM1_NEXT_CLK_ENABLE-details-label:

.. index::
   single: register details; SM1_NEXT_CLK_ENABLE
   single: SM1_NEXT_CLK_ENABLE

:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_NEXT_CLK_ENABLE Register
------------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_BREAKPOINTS Register
--------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM1_TRACEPOINTS Register
--------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_REGX Register
-------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_REGY Register
-------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_PC Register
-----------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_ISR Register
------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_ISR_SHIFT_COUNT Register
------------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_OSR Register
------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_OSR_SHIFT_COUNT Register
------------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_FIFO_MEM0 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_FIFO_MEM1 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_FIFO_MEM2 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_FIFO_MEM3 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_FIFO_MEM4 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_FIFO_MEM5 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_FIFO_MEM6 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_FIFO_MEM7 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_CLEAR_FORCED Register
---------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_CLEAR_EXECD Register
--------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_INSTR_ORIGIN Register
---------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_DELAY Register
--------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_DELAY_CYCLE Register
--------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_PENDING_DELAY Register
----------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_FORCED_INSTR Register
---------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_EXECD_INSTR Register
--------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_CLK_ENABLE Register
-------------------------------------------------------------------------------------------
...
.. _SM2_NEXT_CLK_ENABLE-details-label:

.. index::
   single: register details; SM2_NEXT_CLK_ENABLE
   single: SM2_NEXT_CLK_ENABLE

:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_NEXT_CLK_ENABLE Register
------------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_BREAKPOINTS Register
--------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM2_TRACEPOINTS Register
--------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_REGX Register
-------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_REGY Register
-------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_PC Register
-----------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_ISR Register
------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_ISR_SHIFT_COUNT Register
------------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_OSR Register
------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_OSR_SHIFT_COUNT Register
------------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_FIFO_MEM0 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_FIFO_MEM1 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_FIFO_MEM2 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_FIFO_MEM3 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_FIFO_MEM4 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_FIFO_MEM5 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_FIFO_MEM6 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_FIFO_MEM7 Register
------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_CLEAR_FORCED Register
---------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_CLEAR_EXECD Register
--------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_INSTR_ORIGIN Register
---------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_DELAY Register
--------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_DELAY_CYCLE Register
--------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_PENDING_DELAY Register
----------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_FORCED_INSTR Register
---------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_EXECD_INSTR Register
--------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_CLK_ENABLE Register
-------------------------------------------------------------------------------------------
...
.. _SM3_NEXT_CLK_ENABLE-details-label:

.. index::
   single: register details; SM3_NEXT_CLK_ENABLE
   single: SM3_NEXT_CLK_ENABLE

:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_NEXT_CLK_ENABLE Register
------------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_BREAKPOINTS Register
--------------------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: SM3_TRACEPOINTS Register
--------------------------------------------------------------------------------------------
...
**Offsets:** 0x1b0, 0x1b4, 0x1b8, 0x1bc, 0x1c0, 0x1c4, 0x1c8, 0x1cc, 0x1d0, 0x1d4, 0x1d8, 0x1dc, 0x1e0, 0x1e4, 0x1e8, 0x1ec, 0x1f0, 0x1f4, 0x1f8, 0x1fc, 0x200, 0x204, 0x208, 0x20c, 0x210, 0x214, 0x218, 0x21c, 0x220, 0x224, 0x228, 0x22c
...
.. csv-table::
   ...
   31:16, Unused., "―", ―, ―
   15:0, ―, "Read / write access to instruction memory word.", RW, 0
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: TXF0 Register
---------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: TXF1 Register
---------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: TXF2 Register
---------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: TXF3 Register
---------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: RXF0 Register
---------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: RXF1 Register
---------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: RXF2 Register
---------------------------------------------------------------------------------
...
:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: RXF3 Register
---------------------------------------------------------------------------------
...
.. index::
   single: register details; IRQ
   single: IRQ

:ref:`Emulator PIO Registers <section-top_emulator_pio_registers>`: IRQ Register
--------------------------------------------------------------------------------
...
Direct read access of all PIO IRQ.

.. csv-table::
   :header: Bits, Name, Description, Type, Reset
   :widths: 8, 20, 40, 8, 20

   7, IRQ7, "0x1 for HIGH or 0x0 for LOW", RO, 0
   6, IRQ6, "0x1 for HIGH or 0x0 for LOW", RO, 0
   5, IRQ5, "0x1 for HIGH or 0x0 for LOW", RO, 0
   4, IRQ4, "0x1 for HIGH or 0x0 for LOW", RO, 0
   3, IRQ3, "0x1 for HIGH or 0x0 for LOW", RO, 0
   2, IRQ2, "0x1 for HIGH or 0x0 for LOW", RO, 0
   1, IRQ1, "0x1 for HIGH or 0x0 for LOW", RO, 0
   0, IRQ0, "0x1 for HIGH or 0x0 for LOW", RO, 0
