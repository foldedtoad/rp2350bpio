...
.. csv-table::
   ...
   0x01c, :ref:`GPIO_PADIN <GPIO_PADIN-details-label>`, "Each bit of this value represents the corresponding pad input state of the 32 GPIO pins, virtually provided from some external source."
...
.. _GPIO_PADIN-details-label:

.. index::
   single: register details; GPIO_PADIN
   single: GPIO_PADIN

:ref:`Emulator Global Registers <section-top_emulator_global_registers>`: GPIO_PADIN Register
---------------------------------------------------------------------------------------------
...
Each bit of this value represents the corresponding
pad input state of the 32 GPIO pins, virtually provided
